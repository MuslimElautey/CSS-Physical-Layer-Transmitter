...
for c = 1:length(payload_cases)
    ...
    disp(' ');
    disp('==============================================');
    disp(['PROCESSING TEST CASE: ' current_case ' BYTES']);
    disp('==============================================');
    ...
    % Exporting exact values with case-specific filenames
    dlmwrite(['golden_tx_real_scaled_exact_' current_case '.txt'], golden_real_scaled_exact, 'precision', '%.16g');
    dlmwrite(['golden_tx_imag_scaled_exact_' current_case '.txt'], golden_imag_scaled_exact, 'precision', '%.16g');
    ...
    if max_start_idx > 0
        ...
        for i = 1:3
            ...
            fig_name = ['Case ' current_case 'B - Zoom ' num2str(i) ' (Samples ' num2str(start_idx) '-' num2str(end_idx) ')'];
